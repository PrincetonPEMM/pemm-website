        ...
        <Box className="p-7" sx={{
          ...
          <Box className="pl-5 inline-flex flex-col flex-grow text-center items-center">
            ...
            <Typography className='max-w-sm text-left mt-2'>
              ...
              <p><a href = "mailto: pemm@princeton.edu"><Button color='secondary'>pemm@princeton.edu</Button></a></p>
              <p>© The Trustees of Princeton University</p>
            </Typography>
          </Box>
          <div className="inline-flex flex-col flex-grow text-center">
            <Typography className="text-2xl" color="secondary"
            sx={{
