export const GeneratedStoryText = (props: any) => {
  ...
  return (
    <>
      ...
      {ConstructTranslationSentence(story.appears_in_french, story.appears_in_amharic, story.appears_in_latin, story.appears_in_italian, story.english_translation)} </h2>
      <h2>Summary: </h2>
